...
namespace Celeste.Mod.CommunalHelper.Entities;
    ...
    {
        private bool hasFallen, move, stickOnDash;
        ...
        public override void LandParticles()
        {
            base.LandParticles();
            hasFallen = true;
        }
        ...
        public override void Update()
        {
            ...
            if (move)
            {
                ...
                bool movingRight = moveH > 0;
                bool movingUp = moveV < 0;
                MoveH(moveH);
                MoveV(moveV);
                ...
                bool hitDown = CollideCheck<Solid>(BottomCenter + Vector2.UnitY) || CollideCheck<Platform>(BottomCenter + Vector2.UnitY);
        ...
        {
            if (hasFallen && !move && !landed && direction.Y == 0)
            {
                move = true;
                phase = 0;
                left = direction.X < 0;
